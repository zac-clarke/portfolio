...
const Work = () => {
  ...
  return (
    <>
      ...
      <motion.div
        animate={animateCard} 
        trabsition={{ duration: 0.5, delayChildren: 0.5 }} 
            ...
            <div className="app__work-img app__flex">
              ...
              <motion.div 
                ...
                className="app__work-hover app__flex">
                  {/* TODO: remove noreferrer in final portfolio */}
                  {/* TODO: create a component for icon links */}
...
export default AppWrap(MotionWrap(Work, "app__works"), "work", "bg-primary");
